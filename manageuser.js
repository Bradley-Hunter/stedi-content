...
function userlogin() {
    const AphoneNumber = document.getElementById("username").value;
    const oneTimeCode = document.getElementById("password").value;
    $.ajax({
        type: "POST",
        url: "https://dev.stedi.me/twofactorlogin",
        data: JSON.stringify({ phoneNumber: AphoneNumber, oneTimePassword: oneTimeCode }),
        success: function (data) {
